...
class SecondViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        addObject.trueValues() // appel de la fonction "trueValues" qui insert les valeurs "true" dans un tableau
    }
    //---------------------------
    ...
    //--------------------- Fonction qui permet d'avoir la possibilité de supprimé la rangée de la tableView
