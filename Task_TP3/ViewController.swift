...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource  {
    ...
    //--------------------- Bouton Reset pour deselectionner les taches deja selectionner
    ...
    //--------------------- Fonction qui permet de remplacer un caractere par un autre
     ...
     ******************************************************************************************
     =========================================================================================*/
   //---------------------- Fonction qui retourne nombre de rangée de la tableView
    ...
    //--------------------- Fonction qui permet de modifier le fond de la cellule selectionné 
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        if Array( addObject.dictionnary.values)[indexPath.row] {
            cell.backgroundColor = UIColor (red: 0.40, green: 0.73, blue: 0.68, alpha: 1.0)//changer la couleur de la selection dans la tableView
        }
    }
    ...
    //--------------------- Fonction qui change la valeur true, false et montrer que la rangée est selectionner
